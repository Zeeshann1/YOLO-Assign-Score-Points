...
# @Author  : Qiguangnan
# @File    : chem_allocate_solution_03_conf.py

CNACLRYPZ03 = {
    'name': '一定溶质质量分数的NaCl溶液的配制(电子天平)',
    'experimentId': 'CNACLRYPZ03',
    'isSelect': False,
    'modelPath': 'about_weight/about_weight_2.18.pt',
    'modelClass': 'CHEM_allocate_solution_03',
    'camUse': ['top', 'front'],
    ...
    'scorePointInfo': {
        ...
        '3': {
            'info': '用药匙取固体氯化钠，轻拍手腕（或药匙柄）添加至规定质量',
            'score': 1
        },
        '4': {
