...
# @Author  : Qiguangnan
# @File    : chem_weigh_dissolve_01_conf.py
...
PCLWKMD01 = {
    'name': '测定物块的密度(电子天平)',
    'experimentId': 'PCLWKMD01',
    'isSelect': True,
    'modelPath': 'about_weight/about_weight_2.18.pt',
    'modelClass': 'PHY_measure_density_metal_block_01',
    'camUse': ['top', 'front'],
...
if __name__ == '__main__':
    print(PCLWKMD01['modelInfo'].keys())