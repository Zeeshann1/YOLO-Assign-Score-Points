...
# @Author  : Wupenghui
# @File    : chem_properties_of_base_conf.py

CHEMJDHXXZ01 = {
    'name': '碱的化学性质',
    'experimentId': 'CHEMJDHXXZ01',
    'modelPath': 'chem_properties_of_base_cou/chem_properties_of_base_cou.pt',
    'modelClass': 'CHEM_properties_of_base',
    ...
    'scorePointInfo': {
        '1': {
            'info': '取一支试管，向试管中加入2ml的硫酸铜溶液',
            'score': 2
        },
        '2': {
            'info': '再向硫酸铜溶液中逐滴加入石灰水溶液（稀氢氧化钠溶液）',
            'score': 3
        },
        '3': {
            'info': '观察溶液是否变蓝色',
